  ...
  async function handleParseText() {
    if (pastedText.trim().length < 100) {
      setStage({
        kind: "error",
        message:
          "Paste at least a hundred characters — the meeting times and the deadlines section is plenty.",
      });
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-cream text-ink">
      ...
      <main className="mx-auto max-w-3xl px-6 py-12 sm:px-10 sm:py-16">
        ...
        {/* PARSING */}
        {stage.kind === "parsing" && (
          <div className="flex flex-col items-center gap-4 rounded-2xl border border-rule bg-surface px-8 py-20 text-center">
            ...
            <div className="text-sm text-muted">
              Claude is extracting meeting times and deadlines. This usually
              takes 5–15 seconds for a full syllabus.
            </div>
          </div>
        )}
            ...
            <div className="flex items-center gap-3 border-b border-rule px-6 py-4">
              ...
              <div>
                ...
                <div className="text-sm text-ink-soft">
                  {stage.created}{" "}
                  {stage.created === 1 ? "event" : "events"} created
        ...
        {/* ERROR */}
        {stage.kind === "error" && (
          <div className="flex items-start gap-3 rounded-2xl border border-rule bg-surface px-6 py-5">
            ...
            <div className="flex-1">
              ...
              <div className="mt-1 text-sm text-ink-soft">{stage.message}</div>
              <div className="mt-3">
                <Button
                  size="sm"
                  onClick={() => {
